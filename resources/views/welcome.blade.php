...
<body class="game-container antialiased dark:bg-black dark:text-white/50">
        ...
        <section
            ...
            <article>
                <button id="play-more"
                    ...
                    Jugar ahora
                    <svg id="arrow-l" class="inline" width="16px"
                        height="16px" viewBox="-2 -2 24.00 24.00"
                        version="1.1"
                ...
                <div class="flex flex-row justify-between my-5">
                    ...
                    <div>
                        <button
                            ...
                            < </button>
                                <button
                                    class="rounded-full bg-gray-700 w-7 h-7 border-2 border-white new-games-next">
                                    > </button>
                    </div>
                </div>
                ...
                <div class="flex flex-row justify-between my-5">
                    ...
                    <div>
                        <button
                            ...
                            < </button>
                                <button
                                    class="rounded-full bg-gray-700 w-7 h-7 border-2 border-white clasic-next">
                                    > </button>
                    </div>
                </div>
                ...
                <div class="flex flex-row justify-between my-5">
                    ...
                    <div>
                        <button
                            ...
                            < </button>
                                <button
                                    class="rounded-full bg-gray-700 w-7 h-7 border-2 border-white all-games-next">
                                    > </button>
                    </div>
                </div>
    ...
    <footer
        ...
        <section class="flex my-4 text-white">
            <article class="w-1/3">
                <p>Lorem ipsum dolor sit amet consectetur
                    adipisicing elit. Dignissimos corrupti animi
                    perferendis facilis
                    deserunt quisquam. </p>
                <h4 class="my-7 text-xl">Síguenos en Redes Sociales
                </h4>
                <div>
                    <button
                        class="p-3 font-bold bg-gradient-to-br from-vibrant-pink to-orange rounded-full hover:brightness-150">
            ...
            <article class="w-2/3">
                <div class="grid grid-cols-3">
                    <ul class="gap-y-7">
                        <li>
                            <h2 class="text-xl mb-7 font-bold">Juegos
                            </h2>
                        </li>
                        <li>Destacados</li>
                        <li>Nuevos</li>
                    ...
                    <ul class="gap-y-7">
                        <li>
                            <h2 class="text-xl mb-7 font-bold">Legales
                            </h2>
                        </li>
                    ...
                    <ul class="gap-y-7">
                        <li>
                            <h2 class="text-xl mb-7 font-bold">Ayuda</h2>
                        </li>
        ...
        <hr
            class="h-2 bg-gradient-to-r from-white to-slate-700">
